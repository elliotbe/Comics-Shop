  ...
  <header class="header">
    <div class="container header__container">
      ...
      <div class="header__wrap-link">
        <a class="header__link active-link" href="/login">Se connecter</a>
        <a class="header__link active-link" href="/basket">Panier</a>
      </div>
  ...
  <nav class="nav">
    <div class="container nav__container">
      ...
      <?php foreach ($categories as $categorie): ?>
        <a class="nav__link active-link" href="<?= generateUrl('Product#byColumn', [
          'column' => 'category',
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer__mentions">
        <a href="/mentions-legales">Mentions légales</a> - <a href="/contact">Contacter-nous</a> - ©2019 Yoyote
      </div>
